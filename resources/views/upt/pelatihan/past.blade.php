...
<div class="card">
  <div class="card-header">
    <div class="card-title" style="font-size:11pt">Pelatihan selesai</b></div>
    ...
    <table class="table" style="font-size:10pt">
      ...
      @foreach ($trainings as $training)
        <tr>
          ...
          <td> 
            <a target="_blank" href="{{ route('upt.pelatihan.comfirm.frm', $training->id)}}" style="{{ ($training->status == 1)? '' : 'pointer-events: none;' }}">
